...
| 02 | [Instalação](02-instalacao.md) | Instalar em uma máquina nova |
...
| 08 | [Migração para Raspberry](08-migracao-raspberry.md) | Mudar do PC para o Raspberry Pi |
...
1. Linux + Docker instalados (`scripts/instalar-docker.sh`).
